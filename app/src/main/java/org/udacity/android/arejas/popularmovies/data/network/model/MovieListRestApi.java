 ...
 */
public class MovieListRestApi extends MovieElementRestApi implements Parcelable
{
    ...
    public final static Creator<MovieListRestApi> CREATOR = new Creator<MovieListRestApi>() {

        public MovieListRestApi createFromParcel(Parcel in) {
            return new MovieListRestApi(in);
        }

        public MovieListRestApi[] newArray(int size) {
            return (new MovieListRestApi[size]);
        }

    };

    private MovieListRestApi(Parcel in) {
        ...
        in.readList(this.results, (MovieListRestApi.Result.class.getClassLoader()));
    }

    public MovieListRestApi() {
    }
    ...
    public MovieListRestApi withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public MovieListRestApi withTotalResults(Integer total_results) {
        this.total_results = total_results;
        return this;
    }
    ...
    public MovieListRestApi withTotalPages(Integer total_pages) {
        this.total_pages = total_pages;
        return this;
    }
    ...
    public MovieListRestApi withResults(List<Result> results) {
        this.results = results;
        return this;
    }
    ...
    public void mixWith(MovieListRestApi newMovieList) {
