...
/**
 * Fragment dealing with showing cast of a movie
 */
public class CastFragment extends Fragment {
    ...
    /**
     * Prepare list by filtering credit items related to performance
     * @param data
     * @return
     */
    ...
    /**
     * Show an error on the fragment. The idea has been to escalate errors to the UI classes by the
