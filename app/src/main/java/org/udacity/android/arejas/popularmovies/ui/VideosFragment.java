...
import org.udacity.android.arejas.popularmovies.ui.adapters.MovieVideosListAdapter;
...
public class VideosFragment extends Fragment
        implements MovieVideosListAdapter.OnMovieVideoItemClickListener{

    private FragmentCreditBinding uiBinding;

    private MovieVideosListAdapter mAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // Get the movie activity view model and observe the changes in the videos
        ...
        movieViewModel.getMovieVideos().observe(this, movieVideosResource -> {
            if (movieVideosResource != null) {
                // According to the state of the data, show different layouts
                switch (movieVideosResource.getStatus()) {
                    case ERROR:
                        showError(movieVideosResource.getError());
                        break;
                    case LOADING:
                        showLoading();
                        break;
                    case SUCCESS:
                        updateList(movieVideosResource.getData());
                        break;
                }
            }
        });
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mAdapter = new MovieVideosListAdapter(null, this);
     ...
     * @param data
     */
    private void updateList(List<MovieVideoItem> data) {
        if (uiBinding != null) {
    ...
    /**
     * If clicked a video, open an activity showing video on Youtube.
     *
     * @param item
     */
    @Override
    public void onClick(MovieVideoItem item) {
        if ((item != null) && (item.getKey() != null)) {
            Utils.launchYoutubeVideo(item.getKey());
        }
    }
}
